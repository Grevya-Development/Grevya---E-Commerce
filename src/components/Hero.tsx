          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 lg:pr-12">
              <div className="animate-fade-in">
                <span className="eco-badge mb-3">
                  <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  Eco-friendly & Sustainable
                </span>
                <h1 className="text-4xl lg:text-5xl font-bold text-brown-800 mb-4 leading-tight">
                  Natural Products for <span className="text-green-700">Sustainable</span> Living
                </h1>
                <p className="text-brown-600 text-lg mb-8 max-w-lg">
