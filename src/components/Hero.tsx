...
const Hero = () => {
  return (
    <section className="relative bg-gradient-mesh overflow-hidden pb-10 pt-4 md:pb-16 md:pt-6 lg:pb-20 lg:pt-8 border-b border-[#A68D65]/10 select-none">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center">
            ...
            >
              ...
              >
                Pure Botanical Luxury for{" "}
                <span className="text-[#33381C] italic">Conscious</span> Living
              </motion.h1>
              ...
              >
                Empowering rural communities through sustainable manufacturing.
                Explore our hand-harvested, chemical-free cold-pressed oils,
                pure powders, and bio-plates.
              </motion.p>
              ...
              >
                <Button
                  asChild
                  className="rounded-xl bg-[#33381C] hover:bg-[#262A14] text-[#F7EEE4] px-7 py-6 font-bold transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 text-sm cursor-pointer"
                >
                ...
                <Button
                  asChild
                  variant="ghost"
                  className="rounded-xl border border-[#33381C]/25 text-[#33381C] hover:bg-[#33381C]/5 px-7 py-6 font-bold transition-all duration-300 text-sm cursor-pointer"
                >
              ...
              <motion.div
                ...
                onClick={() =>
                  window.dispatchEvent(
                    new CustomEvent("open-grevya-quickview", {
                      detail: {
                        id: 3,
              ...
              >
                ...
                <div className="flex-grow">
                  <span className="flex items-center text-[8px] font-bold text-[#A68D65] uppercase tracking-wider">
                    <Sparkles className="h-2 w-2 mr-1 text-[#A68D65]" /> Popular
                    Choice
                  </span>
                  <h4 className="font-serif text-sm font-extrabold text-[#33381C] leading-none mt-0.5 animate-pulse">
                    Pure Coconut Oil
                  </h4>
                  <p className="text-[10px] text-[#33381C]/75 font-semibold mt-1">
                    ₹299.00 • Quick View
                  </p>
                </div>
              </motion.div>
