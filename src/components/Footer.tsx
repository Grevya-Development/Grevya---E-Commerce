...
const Footer = () => {
  ...
  useEffect(() => {
    if (!showXTooltip) return;
    const timeout = window.setTimeout(() => setShowXTooltip(false), 1800);
      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <h3 className="font-serif text-2xl font-medium mt-12 mb-5">
              Visit our store
            </h3>
            <ul className="space-y-4 text-neutral-700">
              <li className="flex items-start gap-3">
                ...
                <span>
                  4th South Cross St., Kovai Thiru Nagar, Kalapatty (E),
                  Coimbatore 641014.
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 shrink-0" />
                <a href="mailto:info@grevya.com" className="hover:underline">
                  info@grevya.com
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 shrink-0" />
                <a href="tel:+919566966054" className="hover:underline">
                  95669 66054
                </a>
              </li>
              <li className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-4 mt-8">
              ...
              <div className="relative inline-flex items-center">
                <a
                  href={SOCIAL_LINKS.x || "#"}
                  target={SOCIAL_LINKS.x ? "_blank" : undefined}
                  rel={SOCIAL_LINKS.x ? "noreferrer" : undefined}
                  aria-label="X"
                  className="hover:opacity-70 transition-opacity"
                  onClick={(event) => {
                    if (!SOCIAL_LINKS.x) {
                      event.preventDefault();
                      setShowXTooltip(true);
                    }
                  }}
                >
                  <Twitter size={22} />
                ...
                {showXTooltip && (
                  <div className="absolute bottom-full left-1/2 mb-2.5 -translate-x-1/2 whitespace-nowrap rounded-xl border border-[#A68D65]/20 bg-[#FBF9F6]/95 px-3 py-1.5 text-[12px] font-semibold tracking-[0.01em] text-[#33381C] shadow-[0_10px_24px_rgba(51,56,28,0.12)] backdrop-blur-sm">
                    Coming soon
                  </div>
                )}
              </div>
          ...
          <div>
            ...
            <p className="text-neutral-700 leading-relaxed max-w-md">
              At Grevya Naturals, we believe everyday essentials should be kind
              to you and to the planet. That's why our products are 100% natural
              and eco-friendly, crafted with care and free from harsh
              chemicals—because sustainability should never come with a
              compromise.
            </p>
          </div>
        ...
        <div className="border-t border-neutral-300/70 mt-14 pt-8 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <p className="text-sm text-neutral-600 order-3 lg:order-1">
            &copy; {new Date().getFullYear()} Grevya Naturals. All rights
            reserved.
          </p>
