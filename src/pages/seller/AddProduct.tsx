  ...
  return (
    <SellerLayout>
      <div className="space-y-8">
        <section className="overflow-hidden rounded-[2rem] border border-[#E7E0D4] bg-white shadow-sm">
          <div className="grid gap-8 bg-[linear-gradient(135deg,#F7EEE4_0%,#F1ECE3_52%,#E7E9DD_100%)] p-6 sm:p-8 xl:grid-cols-[1.1fr_0.9fr]">
            <div className="flex flex-col justify-between gap-8">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full border border-[#E7E0D4] bg-white/80 px-4 py-2 text-sm font-semibold text-[#33381C] shadow-sm">
                ...
                <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600">
                  ...
                  customers. Highlight natural materials, honest pricing, stock,
            ...
            <div className="rounded-[1.5rem] border border-white/80 bg-white/75 p-5 shadow-xl shadow-emerald-900/5 backdrop-blur">
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-3xl font-bold text-[#33381C]">
                    {readiness}%
                  </p>
                </div>
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#33381C] text-white shadow-lg shadow-[#E7E0D4]">
                  <Sparkles className="h-6 w-6" />
                </div>
              </div>
              <div className="mt-5 h-3 overflow-hidden rounded-full bg-[#E7E9DD]">
                <div
              ...
              <div className="mt-5 grid gap-3 text-sm text-slate-600">
                ...
                <ChecklistItem
                  done={Number(form.stock) >= 0 && form.stock !== ""}
                >
                  Stock is available
                </ChecklistItem>
          ...
          <div className="space-y-6">
            ...
            <section className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
              <SectionHeader
                icon={ImagePlus}
                title="Product image"
                description="Use a bright, real product photo so customers can inspect quality quickly."
              />
            ...
            <div className="flex flex-col gap-3 rounded-[1.5rem] border border-[#E7E0D4] bg-[#F7EEE4] p-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-start gap-3 text-sm text-[#33381C]">
              ...
              <div className="flex gap-3">
                <button
                  type="button"
                  onClick={resetForm}
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-[#E7E0D4] bg-white px-5 py-3 text-sm font-semibold text-[#33381C] transition hover:border-[#A68D65] hover:bg-[#F1ECE3]"
                >
                ...
                <button
                  type="submit"
                  disabled={!canSubmit}
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-[#33381C] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#E7E0D4] transition hover:bg-[#252813] disabled:cursor-not-allowed disabled:opacity-50"
                >
            ...
            {message && (
              <div className="rounded-2xl border border-[#E7E0D4] bg-[#F7EEE4] px-5 py-4 text-sm font-medium text-[#33381C]">
                {message}
              </div>
            )}
            {error && (
          ...
          <aside className="space-y-6 xl:sticky xl:top-8 xl:self-start">
            <section className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white shadow-sm">
              <div className="relative h-64 bg-slate-100">
                ...
                <div className="absolute left-4 top-4 rounded-full bg-white/90 px-3 py-1 text-xs font-bold text-[#33381C] shadow-sm">
                  Eco listing
                </div>
              </div>

              <div className="p-5">
                <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#A68D65]">
                  Live preview
                </p>
                ...
                <div className="mt-5 grid grid-cols-2 gap-3">
                  <PreviewMetric
                    label="Price"
                    value={
                      previewPrice > 0 ? `₹${previewPrice.toFixed(2)}` : "₹0.00"
                    }
                  />
                  <PreviewMetric
                    label="Stock"
            ...
            <section className="rounded-[1.75rem] border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <div className="mt-5 space-y-3 text-sm leading-6 text-slate-600">
                <p>
                  Use product photos with natural light and plain backgrounds.
                </p>
                <p>
                  Mention material, size, quantity, usage, and care
                  instructions.
                </p>
                <p>
                  Keep claims honest: compostable, reusable, handmade, or
                  organic only when true.
                </p>
              </div>
            </section>
          </aside>
...
function TrustPill({
  ...
  return (
    <div className="rounded-2xl border border-white/80 bg-white/70 p-4 shadow-sm backdrop-blur">
      <Icon className="h-5 w-5 text-[#A68D65]" />
...
function SectionHeader({
  ...
  return (
    <div className="flex items-start gap-4">
      <div className="flex h-12 w-12 flex-none items-center justify-center rounded-2xl bg-[#F1ECE3] text-[#A68D65]">
...
function ChecklistItem({
  ...
  return (
    <div className="flex items-center gap-2">
      <CheckCircle2
        className={`h-4 w-4 ${done ? "text-[#A68D65]" : "text-slate-300"}`}
      />
