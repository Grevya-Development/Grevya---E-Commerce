...
const Products = () => {
  ...
  const shouldRestoreScroll =
    navigationType === "POP" || location.state?.restoreProductsScroll === true;
  const scrollStorageKey = `products-scroll:${location.search}`;
  ...
  const filteredProducts = useMemo(() => {
    ...
    if (sortBy === "price-asc") {
      ...
      result.sort((a, b) => {
        ...
        return reviewCountDifference !== 0
  ...
  useLayoutEffect(() => {
    ...
    if (shouldRestoreScroll && !error && filteredProducts.length === 0) {
      return;
    }
      ...
      <main className="flex-grow pt-6 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-1.5 text-[9px] text-[#33381C]/50 font-bold uppercase tracking-wider mb-4">
            <Link to="/" className="hover:text-[#33381C] transition-colors">
              Home
            </Link>
            <ChevronRight size={9} />
          ...
          {/* Page Header */}
          <div className="mb-6">
            <span className="text-[10px] font-bold uppercase tracking-wider text-[#A68D65]">
              Eco-Friendly Luxury
            </span>
            ...
            <p className="text-[#1D1E19]/60 text-xs md:text-sm max-w-lg">
              Explore our range of 100% natural, biodegradable, and hand-crafted
              sustainable items.
            </p>
          </div>
          ...
          <div className="mb-8 select-none">
            <h3 className="text-[10px] uppercase font-bold tracking-wider text-[#1D1E19]/45 mb-3 flex items-center">
              <Compass className="h-3.5 w-3.5 mr-1.5 text-[#A68D65]" /> Popular
              Collections
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-[200px_1fr] gap-6 md:gap-8">
            ...
            <aside className="hidden md:block space-y-5 select-none">
              <div>
                <h3 className="text-[10px] uppercase font-bold tracking-wider text-[#1D1E19]/45 mb-2.5">
                  Categories
                </h3>
                    ...
                    return (
                      ...
                      >
                        ...
                        <ChevronRight
                          size={11}
                          className={
                            active ? "text-[#F7EEE4]" : "text-neutral-400"
                          }
                        />
                      </button>
                    );
              ...
              {loading ? (
                <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-2 sm:gap-4 md:gap-6">
                  {[1, 2, 3, 4, 5, 6].map((idx) => (
                    <div
                      key={idx}
                      className="bg-[#FBF7F1] rounded-2xl border border-[#A68D65]/12 flex flex-col h-[320px] overflow-hidden animate-pulse"
                    >
                ...
                <div className="text-center py-16 rounded-2xl bg-white border border-[#A68D65]/12 p-6">
                  ...
                  <p className="font-bold text-neutral-700 mb-0.5">
                    No products found
                  </p>
            ...
            >
              <div>
                <div className="flex items-center justify-between border-b border-[#A68D65]/15 pb-3.5 mb-5">
                  <h3 className="font-serif font-bold text-[#33381C] text-lg">
                    Filters
                  </h3>
                  <button
                    onClick={() => setShowMobileFilters(false)}
                ...
                <div className="space-y-5">
                  <div>
                    <h4 className="text-[9px] uppercase font-bold tracking-wider text-[#1D1E19]/45 mb-2.5">
                      Categories
                    </h4>
